    ...
    return (
        <div name='home' className='w-full h-screen bg-[#0a192f]'>
            ...
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                ...
                <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>I'm a Full Stack Engineer.</h2>
                <p className='text-[#8892b0] py-4 max-w-[700px]'>
                    I'm a full-stack engineer with a passion for building
                    and designing exceptional digital experiances.
                    Currently, I'm focused on building responsive
                    full-stack web applications.
                </p>
                <div>
                    <Link onClick={handleClick} to="work" smooth={true} offset={50} duration={500}>
                        <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-red-900 hover:border-red-900'>
                            View Work
